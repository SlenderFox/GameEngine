...
namespace Engine
{
	void Renderer::Init(float pAspect)
	{
		...
		GetShaderAt(0U)->SetInt("u_material.texture_diffuse0", 0);
		GetShaderAt(0U)->SetInt("u_material.texture_specular0", 1);
		...
		//Texture::LoadTexture("../Assets/textures/container2.png");
		//Texture::LoadTexture("../Assets/textures/container2_specular.png");
		...
		//  	std::cout << "Meshes loaded: " << (GetMeshAt(0U) ? "True " : "False ");
