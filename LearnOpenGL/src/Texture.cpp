...
namespace Engine
{
	...
	void Texture::LoadTexture(unsigned int* pTexID, const char* pLocation, bool pTransparent)
	{
		...
		unsigned char* m_imageData = stbi_load(pLocation, &m_texWidth, &m_texHeight, &m_texColChannels, 0);
		if (m_imageData)
		{
