...
colour colour::black()    noexcept { return colour(0.0f); }
colour colour::white()    noexcept { return colour(1.0f); }
colour colour::silver()   noexcept { return colour(0.75f, 0.75f, 0.75f ); }
colour colour::grey()     noexcept { return colour(0.5f,  0.5f,  0.5f  ); }
colour colour::darkGrey() noexcept { return colour(0.25f, 0.25f, 0.25f ); }
colour colour::red()      noexcept { return colour(1.0f,  0.0f,  0.0f  ); }
colour colour::lime()     noexcept { return colour(0.0f,  1.0f,  0.0f  ); }
colour colour::blue()     noexcept { return colour(0.0f,  0.0f,  1.0f  ); }
colour colour::yellow()   noexcept { return colour(1.0f,  1.0f,  0.0f  ); }
colour colour::cyan()     noexcept { return colour(0.0f,  1.0f,  1.0f  ); }
colour colour::magenta()  noexcept { return colour(1.0f,  0.0f,  1.0f  ); }
colour colour::maroon()   noexcept { return colour(0.5f,  0.0f,  0.0f  ); }
colour colour::green()    noexcept { return colour(0.0f,  0.5f,  0.0f  ); }
colour colour::navy()     noexcept { return colour(0.0f,  0.0f,  0.5f  ); }
colour colour::olive()    noexcept { return colour(0.5f,  0.5f,  0.0f  ); }
colour colour::teal()     noexcept { return colour(0.0f,  0.5f,  0.5f  ); }
colour colour::purple()   noexcept { return colour(0.5f,  0.0f,  0.5f  ); }
